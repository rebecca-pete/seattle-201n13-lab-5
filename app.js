...
function multiply(a, b) { //eslint-disable-line
  var multiply = a * b;
  var mString = 'The product of ' + a + ' and ' + b + ' is ' + multiply + '.';
  return([multiply, mString]);
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var aSum = sum(a, b);
  var newSum = sum(aSum[0], c);
  var sumAll = newSum[0];

  var aProduct = multiply(a, b);
  var newProduct = multiply(aProduct[0], c);
  var productAll = newProduct[0];

  var aString = a + ' and ' + b + ' and ' + c + ' sum to ' + sumAll + '.';
  var bString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productAll + '.';
  return([sumAll, productAll, aString, bString]);
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var aArr = sumAndMultiply(a, b, c);
  console.log(aArr);
  var newSum = aArr[0];
  console.log(newSum);

  var sString = a + ',' + b + ',' + c + ' was passed in as an array of numbers, and ' + aArr[0] + ' is their sum.';
  console.log(sString);
  return([newSum, sString]);
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var b = testArray[1];
  var c = testArray[2];
  var prodNumFun = multiply(a, b);
  var prodNum = prodNumFun[0];
  var prodNumFunB = multiply(prodNumFun[0], c);
  var prodNumTotal = prodNumFunB[0];
  var prodString = 'The numbers ' + a + ',' + b + ',' + c + ' have a product of ' + prodNumTotal + '.';

  return([prodNumTotal, prodString]);
